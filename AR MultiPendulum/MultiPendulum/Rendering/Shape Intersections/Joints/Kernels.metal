...
#include "../../../../Other/Utilities/Metal/CentralObjectUtilities.metal"
...
typedef struct {
    ...
    bool  doingMixedRealityRendering;
} ComputeUniforms;
                                  ...
                                  ushort  thread_id [[ thread_index_in_threadgroup ]])
{
    ...
    if (CentralObjectUtilities::shouldCull(tg_cullMasks,
                                           cullVertex,
                                  ...
                                  ushort2 grid_size [[ threads_per_grid ]])
{
    ...
    if (CentralObjectUtilities::Serial::shouldCull(cullVertices))
    {
        return;
    }
    ...
    LOD lod = CentralObjectUtilities::Serial::getLOD(vertexUniforms.modelToWorldTransform,
                                                     vertexUniforms.worldToModelTransform,
                                                     worldToCameraTransforms,
                                                     cameraPositions,
                                                     computeUniforms.doingMixedRealityRendering,
