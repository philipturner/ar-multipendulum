...
extension PendulumRenderer {
    ...
    func createStandObjects() {
        ...
        standObjects.append(ARObject(roundShapeType: .cylinder,
                                     bottomPosition: baseBottom,
                                     topPosition:    baseTop,
                                     diameter: 0.30,
        ...
        func appendStandObject() {
            standObjects.append(ARObject(roundShapeType: .cylinder,
                                         bottomPosition: baseTop,
                                         topPosition:   standTop,
        ...
        func appendPivotObject(depths: simd_float2) {
            ...
            standObjects.append(ARObject(roundShapeType: .cylinder,
                                         bottomPosition: pivotStart,
                                         topPosition:    pivotEnd,
