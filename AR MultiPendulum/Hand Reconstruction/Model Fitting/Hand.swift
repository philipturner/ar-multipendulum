...
struct Hand {
    ...
    func getWireframeObjects(color: simd_float3 = ProcessInfo.processInfo.thermalStateColor) -> [CentralObject] {
        var objects = [CentralObject](capacity: 43)
    ...
    func getJointObject(position: simd_float3, color: simd_float3) -> CentralObject {
        CentralObject(shapeType: .sphere,
                      position: position,
    ...
    func getConnectionObject(start: simd_float3, end: simd_float3, color: simd_float3) -> CentralObject? {
        CentralObject(roundShapeType: .cylinder,
                      modelSpaceBottom: start,
                      modelSpaceTop: end,
                      diameter: 0.012,
    ...
    func getComponentObjects(componentID: Int, color: simd_float3) -> [CentralObject] {
    ...
    func getDirectionObjects() -> [CentralObject] {
        var output = [CentralObject](capacity: 10)
        ...
        func makeArrow(direction: simd_float3, start: simd_float3 = center,
            ...
            if let base = CentralObject(roundShapeType: .cylinder,
                                        modelSpaceBottom: start,
                                        modelSpaceTop: baseEnd,
                                        diameter: 0.0105,
            ...
            if let tip = CentralObject(roundShapeType: .cone,
                                       modelSpaceBottom: baseEnd,
                                       modelSpaceTop: tipEnd,
                                       diameter: 0.015,
    ...
    func getCenterObject() -> CentralObject {
        CentralObject(shapeType: .sphere,
                      position: center,
