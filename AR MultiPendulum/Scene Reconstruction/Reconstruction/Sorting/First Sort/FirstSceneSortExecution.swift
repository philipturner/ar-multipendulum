...
extension FirstSceneSorter {
    ...
    func doFirstSort() {
        ...
        computeEncoder.setBuffer(bridgeBuffer, level: .numVertexThreads, index: 2)
        ...
        computeEncoder.setBuffer(bridgeBuffer, level: .octantData16, index: 3)
        ...
        computeEncoder.setBuffer(bridgeBuffer, level: .octantData256, index: 4)
        ...
        computeEncoder.setBuffer(bridgeBuffer, level: .octantData4096, index: 5)
        ...
        computeEncoder.setBuffer(bridgeBuffer, level: .octantOffsets4096, index: 6)
        computeEncoder.setBuffer(bridgeBuffer, level: .octantOffsets256,  index: 7)
        computeEncoder.dispatchThreadgroups([ num4096Groups ], threadsPerThreadgroup: 1)
        
        computeEncoder.setComputePipelineState(markWorldOctantOffsets256PipelineState)
        computeEncoder.setBuffer(bridgeBuffer, level: .octantData16,    index: 3)
        computeEncoder.setBuffer(bridgeBuffer, level: .octantOffsets16, index: 8)
