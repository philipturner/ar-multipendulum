...
extension SecondSceneSorter {
    ...
    func doSecondSort() {
        ...
        computeEncoder.setBuffer(bridgeBuffer,      level: .octantMark,       index: 0)
        computeEncoder.setBuffer(largeSectorBuffer, level: .numVertexThreads, index: 1)
        computeEncoder.setBuffer(largeSectorBuffer, level: .bounds,           index: 2)
        ...
        for i in 1..<numFocusNodes {
            ...
            computeEncoder.setBuffer(bridgeBuffer,      level: .octantMark,       offset: octantMarkOffset,       index: 0, asOffset: true)
            computeEncoder.setBuffer(largeSectorBuffer, level: .numVertexThreads, offset: numVertexThreadsOffset, index: 1, asOffset: true)
            computeEncoder.setBuffer(largeSectorBuffer, level: .bounds,           offset: boundsOffset,           index: 2, asOffset: true)
        ...
        if numFocusNodes > 1 {
            computeEncoder.setBuffer(bridgeBuffer, level: .octantMark, offset: 0, index: 0, asOffset: true)
        }
        ...
        computeEncoder.setBuffer(bridgeBuffer, level: .octantCounts16, index: 5)
        ...
        computeEncoder.setBuffer(bridgeBuffer, level: .octantCounts128, index: 6)
        ...
        computeEncoder.setBuffer(bridgeBuffer, level: .octantCounts2048, index: 7)
        ...
        computeEncoder.setBuffer(bridgeBuffer, level: .octantCounts128,   index: 6)
        computeEncoder.setBuffer(bridgeBuffer, level: .octantOffsets2048, index: 8)
        computeEncoder.setBuffer(bridgeBuffer, level: .octantOffsets128,  index: 9)
        computeEncoder.dispatchThreadgroups([ totalNum2048Groups ], threadsPerThreadgroup: 1)
        
        computeEncoder.setComputePipelineState(markLargeSectorOctantOffsets128PipelineState)
        computeEncoder.setBuffer(bridgeBuffer, level: .octantCounts16,  index: 5)
        computeEncoder.setBuffer(bridgeBuffer, level: .octantOffsets16, index: 10)
        computeEncoder.dispatchThreadgroups([ expandedVertexCount >> 7 ], threadsPerThreadgroup: 1)
        ...
        computeEncoder.setBuffer(bridgeBuffer, level: .idBufferOffsets2048, index: 11)
