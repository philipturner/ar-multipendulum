...
vertex MRVertexInOut sceneMRVertexTransform(SCENE_VERTEX_TRANSFORM_PARAMS,
                                            constant float &positionDelta [[ buffer(29) ]],
                                            
                                            ushort amp_id [[ amplification_id ]])
{
    auto out = CALL_SCENE_VERTEX_TRANSFORM_COMMON(MRVertexInOut, 2, amp_id, positionDelta);
    out.layer = amp_id;
    
    return out;
}

vertex VertexInOut sceneMRVertexTransform2(SCENE_VERTEX_TRANSFORM_PARAMS,
                                           constant float  &positionDelta [[ buffer(29) ]],
...
[[early_fragment_tests]]
fragment half3 sceneMRFragmentShader(VertexInOut in [[ stage_in ]], SCENE_FRAGMENT_SHADER_PARAMS)
{
