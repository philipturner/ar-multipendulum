...
vertex MRVertexInOut pendulumVRRectangleTransform(PENDULUM_RECTANGLE_TRANSFORM_PARAMS(MRVertexUniforms),
...
vertex VertexInOut pendulumVRRectangleTransform2(PENDULUM_RECTANGLE_TRANSFORM_PARAMS(MRVertexUniforms),
...
vertex MRVertexInOut pendulumVRJointTransform(PENDULUM_JOINT_TRANSFORM_PARAMS(MRVertexUniforms),
                                              constant float3 &eyeDirectionDelta [[ buffer(28) ]],
                                              constant float  &positionDelta     [[ buffer(29) ]],
...
vertex VertexInOut pendulumVRJointTransform2(PENDULUM_JOINT_TRANSFORM_PARAMS(MRVertexUniforms),
                                             constant ushort &amp_id [[ buffer(30) ]])
{
    return pendulumJointTransformCommon<VertexInOut>(vertexUniforms, baseVertices,
                                                     jointVertices, edgeVertices, edgeNormals,
